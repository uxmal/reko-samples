...
Eq_75: (struct "Eq_75" 0001 (0 (arr Eq_75) a0000))
	T_75 (in 0<32> : word32)
	T_79 (in Mem16[x0 + (int64) ((int32) w0_15):word32] : word32)
	T_80
	T_81
// Type Variables ////////////
globals_t: (in globals : (ptr64 (struct "Globals")))
...
T_11: (in 0<64> : word64)
  ...
  DataType: word64
  OrigDataType: word64
T_12: (in globals->qw10FE0 == 0<64> : bool)
  Class: Eq_12
  DataType: bool
  OrigDataType: bool
...
T_47: (in Mem11[0x0000000000011020<p64>:byte] : byte)
  ...
  DataType: byte
  OrigDataType: byte
T_48: (in (word32) Mem11[0x0000000000011020<p64>:byte] : word32)
  Class: Eq_48
  DataType: word32
  OrigDataType: word32
T_49: (in 0<32> : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_50: (in (word32) globals->b11020 != 0<32> : bool)
  Class: Eq_50
  DataType: bool
  OrigDataType: bool
...
T_53: (in 0<64> : word64)
  ...
  DataType: word64
  OrigDataType: word64
T_54: (in globals->qw10FC8 == 0<64> : bool)
  Class: Eq_54
  DataType: bool
  OrigDataType: bool
T_55: (in deregister_tm_clones : ptr64)
...
T_66: (in register_tm_clones() : void)
  ...
  DataType: void
  OrigDataType: void
T_67: (in x0 : (arr Eq_75))
  Class: Eq_67
  DataType: (ptr64 (arr Eq_75))
  OrigDataType: (ptr64 (struct (0 (arr T_80) a0000)))
...
T_75: (in 0<32> : word32)
  Class: Eq_75
  DataType: (struct "Eq_75" 0001 (0 (arr Eq_75) a0000))
  OrigDataType: word32
T_76: (in (int32) w0_15 : int32)
  Class: Eq_76
  DataType: int32
  OrigDataType: int32
T_77: (in (int64) (int32) w0_15 : int64)
  Class: Eq_77
  DataType: int64
  OrigDataType: int64
T_78: (in x0 + (int64) ((int32) w0_15) : word64)
  Class: Eq_78
