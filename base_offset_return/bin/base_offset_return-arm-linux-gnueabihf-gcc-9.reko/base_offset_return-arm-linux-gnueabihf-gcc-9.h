...
Eq_36: (union "Eq_36" (int32 u0) (uint32 u1))
	T_36 (in r1_9 : Eq_36)
	T_45 (in globals->dw033C + 0x320<u32> - (globals->dw0338 + 0x31C<u32>) : word32)
...
T_9: (in Mem0[0x000002E0<p32>:word32] : word32)
  ...
  DataType: int32
  OrigDataType: int32
T_10: (in 0x2D4<u32> + globals->dw02E0 : word32)
  Class: Eq_10
  DataType: ptr32
  OrigDataType: ptr32
...
T_12: (in Mem0[0x000002E4<p32>:word32] : word32)
  ...
  DataType: int32
  OrigDataType: int32
T_13: (in 0x2D4<u32> + globals->dw02E0 + globals->dw02E4 : word32)
  Class: Eq_13
...
T_15: (in 0<32> : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_16: (in 0x2D4<u32> + globals->dw02E0 + globals->dw02E4 != 0<32> : bool)
  Class: Eq_16
  DataType: bool
  OrigDataType: bool
...
T_23: (in 000002F8 : ptr32)
  ...
  DataType: ptr32
  OrigDataType: ptr32
T_24: (in globals->dw030C + 0x2F8<u32> : word32)
  Class: Eq_20
  DataType: ptr32
  OrigDataType: word32
T_25: (in 0<32> : word32)
...
T_29: (in Mem0[0x00000310<p32>:word32] : word32)
  ...
  DataType: int32
  OrigDataType: int32
T_30: (in r2_9 + globals->dw0310 : word32)
  Class: Eq_30
  DataType: (ptr32 (ptr32 code))
...
T_39: (in 00000320 : ptr32)
  ...
  DataType: ptr32
  OrigDataType: ptr32
T_40: (in globals->dw033C + 0x320<u32> : word32)
  Class: Eq_40
  DataType: word32
  OrigDataType: word32
...
T_43: (in 0000031C : ptr32)
  ...
  DataType: ptr32
  OrigDataType: ptr32
T_44: (in globals->dw0338 + 0x31C<u32> : word32)
  Class: Eq_44
  DataType: word32
  OrigDataType: word32
T_45: (in globals->dw033C + 0x320<u32> - (globals->dw0338 + 0x31C<u32>) : word32)
...
T_49: (in 00000324 : ptr32)
  ...
  DataType: ptr32
  OrigDataType: ptr32
T_50: (in globals->dw0340 + 0x324<u32> : word32)
  Class: Eq_46
  DataType: ptr32
  OrigDataType: word32
...
T_62: (in Mem0[0x00000344<p32>:word32] : word32)
  ...
  DataType: int32
  OrigDataType: int32
T_63: (in r2_10 + globals->dw0344 : word32)
  Class: Eq_63
  DataType: (ptr32 (ptr32 code))
...
T_70: (in 00000354 : ptr32)
  ...
  DataType: ptr32
  OrigDataType: ptr32
T_71: (in globals->dw0378 + 0x354<u32> : word32)
  Class: Eq_67
  DataType: ptr32
  OrigDataType: word32
...
T_76: (in Mem7[Mem7[0x00000374<p32>:word32] + 0x00000352<p32>:byte] : byte)
  ...
  DataType: byte
  OrigDataType: byte
T_77: (in (word32) Mem7[Mem7[0x00000374<p32>:word32] + 0x00000352<p32>:byte] : word32)
  Class: Eq_77
  DataType: word32
  OrigDataType: word32
T_78: (in 0<32> : word32)
...
T_81: (in Mem7[0x0000037C<p32>:word32] : word32)
  ...
  DataType: int32
  OrigDataType: int32
T_82: (in r2_11 + globals->dw037C : word32)
  Class: Eq_82
  DataType: (ptr32 word32)
...
T_84: (in 0<32> : word32)
  ...
  DataType: word32
  OrigDataType: word32
T_85: (in r2_11 + globals->dw037C == 0<32> : bool)
  Class: Eq_85
  DataType: bool
  OrigDataType: bool
T_86: (in deregister_tm_clones : ptr32)
