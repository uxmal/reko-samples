...
#include "base_offset_return-s390x-linux-gnu-gcc-9_text.h"
...
// 00000498: void register_tm_clones(Register Eq_28 r14)
// Called from:
//      frame_dummy
void register_tm_clones(Eq_28 r14)
{
	Eq_35 r1_7 = SEQ(SLICE(r1, word32, 32), 0x2010) - SEQ(SLICE(r2, word32, 32), 0x2010);
	if ((r1_7 >>u 63) + (r1_7 >> 3) >> 1 == 0x00)
		r14();
}
...
// 00000590: void frame_dummy(Register Eq_28 r14)
// Called from:
//      _init
void frame_dummy(Eq_28 r14)
{
	if (CC)
