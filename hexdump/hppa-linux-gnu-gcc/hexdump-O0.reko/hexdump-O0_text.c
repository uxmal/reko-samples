...
// 0000046C: Register word64 fn0000046C(Register (ptr64 Eq_n) r19)
// Called from:
//      main
word64 fn0000046C(struct Eq_n * r19)
{
	word64 r22_n;
	((uint64) r19->dwFFFFFFD4)();
	return r22_n;
}
...
{
	uint64 r2_n;
	Eq_n r25_n = r19->dw003C - r19->dw0010;
	word32 dwLoc14_n = (word32) r2;
	if ((int32) SLICE((uint32) SLICE(r25_n, bool, 32) + (int32) SLICE(r25_n, word30, 3), word31, 2) != 0x00)
	{
...
{
	fn00000458(r19);
	0x00 = (word64) (uint32) SLICE(fn0000046C(r19), bool, 2);
}

// 00000850: void fn00000850(Register Eq_n r22)
// Called from:
//      gmon_initializer
//      deregister_tm_clones
//      frame_dummy
//      __do_global_ctors_aux
void fn00000850(Eq_n r22)
{
	0x00 = (word64) (uint32) SLICE(r22, bool, 2);
	r22();
}

// 00000864: Register uint64 __canonicalize_funcptr_for_compare(Register uint64 r2, Register Eq_n r3, Register Eq_n r26, Register out Eq_n r3Out, Register out Eq_n r28Out)
// Called from:
//      gmon_initializer
//      __do_global_ctors_aux
...
// 000009A4: void __do_global_ctors_aux(Register word64 r0, Register uint64 r2, Register Eq_n r3, Register word64 r7, Register (ptr64 Eq_n) r19, Register uint64 r31)
// Called from:
//      _init
...
// 00000A58: void call___do_global_ctors_aux()
