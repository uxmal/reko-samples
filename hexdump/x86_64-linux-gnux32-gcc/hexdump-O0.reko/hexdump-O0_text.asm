...
E8 1B FE FF FF  	call	1040h
89 C1           	mov	ecx,eax
67 8B 45 EC     	mov	eax,[ebp-14h]
8B 15 B7 2D 00 00 	mov	edx,[0000000000003FE8]               ; [rip+00002DB7]
89 D7           	mov	edi,edx
41 89 D8        	mov	r8d,ebx
89 C2           	mov	edx,eax
BE 03 00 00 00  	mov	esi,3h
E8 0E FE FF FF  	call	1050h
B8 00 00 00 00  	mov	eax,0h
67 48 8B 5D F8  	mov	rbx,[ebp-8h]
C9              	leave
C3              	ret
000000000000124E                                           66 90               f.
