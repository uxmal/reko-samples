...
48 8B 05 F1 2D 00 00 	mov	rax,[0000000000003FE8]            ; [rip+00002DF1]
48 89 C7        	mov	rdi,rax
E8 41 FE FF FF  	call	1040h
B8 00 00 00 00  	mov	eax,0h
48 8B 5D F8     	mov	rbx,[rbp-8h]
C9              	leave
C3              	ret
