...
51              	push	ecx
83 EC 08        	sub	esp,8h
E8 52 FE FF FF  	call	1060h
81 C3 F2 2D 00 00 	add	ebx,2DF2h
89 CE           	mov	esi,ecx
8B 06           	mov	eax,[esi]
...
;; __x86.get_pc_thunk.ax: 00001255
__x86.get_pc_thunk.ax proc
8B 04 24        	mov	eax,[esp]
C3              	ret
00001259                            66 90 66 90 66 90 90          f.f.f..
