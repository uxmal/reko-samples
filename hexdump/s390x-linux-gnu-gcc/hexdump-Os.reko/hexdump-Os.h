...
Eq_31: (union "Eq_31" (int64 u0) (uint64 u1))
	T_31 (in r3_5 >> 63<i32> : word64)
Eq_33: (union "Eq_33" (int64 u0) (uint64 u1))
	T_33 (in r3_5 >> 3<i32> : word64)
Eq_34: (union "Eq_34" (int64 u0) (uint64 u1))
	T_34 (in (r3_5 >>u 63<i32>) + (r3_5 >> 3<i32>) : word64)
...
T_35: (in 1<i32> : int32)
  ...
  DataType: int32
  OrigDataType: int32
T_36: (in (r3_5 >>u 63<i32>) + (r3_5 >> 3<i32>) >> 1<i32> : word64)
  Class: Eq_36
  DataType: int64
  OrigDataType: int64
T_37: (in 0<64> : word64)
  ...
  DataType: int64
  OrigDataType: word64
T_38: (in (r3_5 >>u 63<i32>) + (r3_5 >> 3<i32>) >> 1<i32> != 0<64> : bool)
  Class: Eq_38
  DataType: bool
  OrigDataType: bool
T_39: (in CC : byte)
